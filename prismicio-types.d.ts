...
/**
 * Item in *Blogs → Navigation*
 */
export interface BlogsDocumentDataNavigationItem {
  /**
   * Link field in *Blogs → Navigation*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: blogs.navigation[].link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  link: prismic.LinkField;

  /**
   * Text field in *Blogs → Navigation*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: blogs.navigation[].text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
interface BlogsDocumentData {
  /**
   * Navigation field in *Blogs*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: blogs.navigation[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  navigation: prismic.GroupField<Simplify<BlogsDocumentDataNavigationItem>>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      BlogsDocument,
      BlogsDocumentData,
      BlogsDocumentDataNavigationItem,
